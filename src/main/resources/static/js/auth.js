var Auth = {
	vars: {
		...
		password_input: document.querySelector('#loginPassword'),
	...
	forgot(e) {
		...
		Auth.vars.password_input.setAttribute('disabled','true');//添加
	...
	loginback(e) {
		...
		Auth.vars.password_input.removeAttribute('disabled');//添加
		setTimeout(() => {
